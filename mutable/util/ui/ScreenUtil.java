...
public class ScreenUtil{
	...
	*
	...
	/** else throw */
	public static BufferedImage image(byte[] content){
		try{
			BufferedImage b = ImageIO.read(new ByteArrayInputStream(content));
	...
	public static void displayImage(byte[] imageBytes){
		JFrame j = new JFrame("image"){
			public void paint(Graphics g){
				g.drawImage(image(imageBytes), 0, 50, this);
			}
		};
		j.setSize(500, 500);
		j.setVisible(true);
